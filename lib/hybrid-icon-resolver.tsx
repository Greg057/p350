...
// Custom SVG components for platforms not available in Lucide/Radix
...
/**
 * Hybrid icon resolver that handles both library icons and custom SVG data
...
export function renderIcon(iconKey: string, className?: string) {
  ...
  const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
    // Social platforms - mix of library and custom icons
    github: GitHubIcon,
    linkedin: Linkedin,
    youtube: YouTubeIcon,
    ...
    // Custom SVG components for platforms not in libraries
    x: XIcon,
